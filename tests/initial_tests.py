...
class MyTestCase(BaseTestCase):
    ...
    def setUpClass(cls):
        ...
        fh = logging.FileHandler(os.path.join(GLHE.CLAY.globals.config["DIRECTORIES"]["LOGGING_DIRECTORY"], "GLHE_root_test.log"))
    ...
    def test_name(self):
        self.random_dataset = xarray_helpers.label_xarray_dataset_with_product_name(self.random_dataset,
                                                                                   "TerraClimateDummyData")
        self.assertEqual(self.random_dataset.attrs['product_name'], "TerraClimateDummyData")
