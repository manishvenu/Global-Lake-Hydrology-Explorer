...
def fix_weird_units_descriptors_in_xarray_datasets(dataset: xr.Dataset, var: str, correct_unit: str) -> xr.Dataset:
    """
...
def add_descriptive_time_component_to_units_in_xarray_dataset(dataset: xr.Dataset, time_denominator: str) -> xr.Dataset:
    """
...
def convert_xarray_dataset_units(dataset: xr.Dataset, output_unit: str, *variable: str) -> xr.Dataset:
    """
